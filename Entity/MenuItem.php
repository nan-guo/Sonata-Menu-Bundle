...
class MenuItem implements MenuItemInterface
{
    ...
    /**
     * @var \Prodigious\Sonata\PageBundle\Entity\MenuItem
     *
     * @ORM\ManyToOne(targetEntity="Prodigious\Sonata\MenuBundle\Entity\MenuItem", inversedBy="children", cascade={"remove", "persist"})
     ...
     * Get parent
     *
     * @return \Prodigious\Sonata\MenuBundle\Entity\MenuItem
     */
     ...
     * Set parent
     *
     * @param \Prodigious\Sonata\MenuBundle\Entity\MenuItem $parent
     *
     * @return MenuItem
     */
     ...
     * Add child
     *
     * @param \Prodigious\Sonata\MenuBundle\Entity\MenuItemInterface $child
     *
     * @return $this
     */
    public function addChild(\Prodigious\Sonata\MenuBundle\Entity\MenuItemInterface $child)
    {
        $this->children[] = $child;
     ...
     * @param \Prodigious\Sonata\MenuBundle\Entity\MenuItemInterface $child
     */
    public function removeChild(\Prodigious\Sonata\MenuBundle\Entity\MenuItemInterface $child)
    {
     ...
     * Set menu
     *
     * @param \Prodigious\Sonata\MenuBundle\Entity\MenuInterface $menu
     *
     * @return MenuItem
     */
    public function setMenu(\Prodigious\Sonata\MenuBundle\Entity\MenuInterface $menu)
    {
        $this->menu = $menu;
     ...
     * Get menu
     *
     * @return \Prodigious\Sonata\MenuBundle\Entity\MenuInterface
     */
